...
public class RoleAction {
	...
	public void doUpdate(@FormGroup("role") RoleDO roleDO, Navigator nav) {
		...
		nav.redirectTo("admin").withTarget("role.vm");
	}
	
	public void doDelete(@FormGroup("role") RoleDO roleDO, Navigator nav) {
